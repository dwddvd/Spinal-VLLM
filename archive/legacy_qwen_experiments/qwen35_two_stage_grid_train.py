...
def compute_region_classification_metrics(
    ...
    """
    assert len(gt_regions) == len(pred_regions)
...
# =====================================
# Stage-1 Grid detector prompts/answers
# =====================================
...
class TwoStageDatasetBuilder:
    def __init__(self, processor, task: str, max_length: int, crop_expand_ratio: float = 0.1, grid_size: int = 3):
...
def main():
    ...
    parser.add_argument("--det_output_dir", type=str,
                        default="/home/dwd/桌面/Spinal-qwen-finetune/output/qwen35_stage1_det_grid")
    ...
    parser.add_argument("--swanlab_experiment", type=str, default="two-stage-grid")
